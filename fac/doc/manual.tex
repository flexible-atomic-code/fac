...
\newcommand{\facversion}{{0.8.8}\xspace}
\newcommand{\opt}[1]{
...
Step-by-step instructions can be found in the README file in the top directory
of FAC distribution.
...
\begin{fundesc}{ReinitExciation}{m}
...
format. \var{energy} is a list or tuple giving the electron energies in eV
...
in the level file. Both default to -1, i.e., include all recombined
states. Before calling this function, \key{MemENTable()} must be called.
\end{fundesc}
