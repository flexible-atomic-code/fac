...
\item[\texttt{float br}:] The radiative branching ratio of the autoionizing
state.
...
NREC	= 6
#AILevel 2J  RecLevel 2J ibase  NREC L ERes       AI Rate     Total Rate  Branching
  275     0        37  3     0     6 0 1.2462E+01 1.1031E+13  1.1348E+13  2.7940E-02
......
\end{verbatim}
...
\begin{fundesc}{TotalRRCross}{ifn, ofn, ilev, energy\opt{, n0, n1, nmax}}
...
the calculated cross sections. Before calling this function,
\key{MemENTable()} must be called.
\end{fundesc}
...
\begin{fundesc}{DRStrength}{fn, n, \opt{i}}
...
database file. \var{i} is optional, whose default is 0. When \var{i}$\ge$0,
then the it is the index of the recombining state relative to the ground state
...
are used if \var{m} is 1. The default is 1. The results are in unit of
$10^{-10}$ cm$^3$ s$^{-1}$.
\end{fundesc}
