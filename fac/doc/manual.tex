...
\newcommand{\facversion}{{1.0.0}\xspace}
\newcommand{\opt}[1]{
...
\begin{fundesc}{PopulationTable}{fn, den}
Calculate the magnetic sublevel populations at electron density \var{den}, and
...
\begin{fundesc}{SetMCERates}{fn, E}
Setup the magnetic sublevel excitation rates at electron energy
\var{E}. Excitation cross sections are interpolated from the binary data file
\var{fn}.
\end{fundesc}
