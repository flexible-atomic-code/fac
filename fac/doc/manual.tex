...
\begin{fundesc}{SlaterCoeff}{fn, g}
...
ket state, which have the same $l$ values. Because we work in the
...
configurations. The format of the file is as follows. For each state, a line
...
column is the level index. The second column is the rank of the exchange
integral (either 1 or 2). The 3rd, 4th, and 5th columns are the $n$, $kappa$,
$l$ values of the $\alpha$ orbital. The 6th column is either 0 or 1,
indicating whether $\alpha$ and $\alpha^\prime$ have the same $j$ values. The
7-10th  columns are the corresponding values for the $\beta$ orbital. The 11th
column is the expansion coefficients $g_k$. The 12th column is the
corresponding exchange slater integrals.
\end{fundesc}
