...
\newcommand{\facversion}{{1.1.0}\xspace}
\newcommand{\opt}[1]{
...
\begin{fundesc}{StructureMBPT}{efn, hfn, g, kmax, n1, n2\opt{, n0}}
...
\var{n2} grid is for the second electron of the double excitation. The
optional $n0$ is an integer specifying the number of configuration groups in
the \var{g} list to be included in the MBPT calculation, and the remaining are
included for all-order perturbation treatment.
\end{fundesc}

\begin{fundesc}{StructureMBPT}{efn, hfn1, hfns, g}
This is the second form of the \key{StructureMBPT} function. It reads the
...
\key{Structure}. The configuration list \var{g} must be the same as those used
in generating the \var{hfns} files.
\end{fundesc}

\begin{fundesc}{StructureMBPT}{m}
This is the third form of the \key{StructureMBPT} function. It sets an option
...
\begin{fundesc}{StructureMBPT}{p, j, i}
This is the fourth form of the \key{StructureMBPT} function. It sets which
$\pi J$ symmetry and/or which level to include in the MBPT calculation. By
default, all symmetries are processes. But if this function is called with
$p=0$, or 1, $j \ge 0$, then only the specified symmetry is processes. $j$ is
the twice of the actual value of the total angular momentum. If $i\ge 0$, then
only the $i$-th level in the symmetry is included.
\end{fundesc}

\begin{fundesc}{StructureMBPT}{m, c}
This is the fifth form of the \key{StructureMBPT} function. It sets two
options. \var{m} indicates whether only single excitation or double excitation
should be included. If $m=0$, both single and double excitations are included;
