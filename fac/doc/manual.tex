...
propagation zone via a call to \key{SetBoundary}(-100, \var{r1}, \var{r0}).
\end{fundesc}
...
\begin{fundesc}{StructureMBPT}{fn1, fn2, g0, g1, n0, ni, n1, k, nt, 
n2, nt2, gn\opt{,x1, x2}} 
Solve the atomic structure with 2nd order many-body perturbation
