...
transition rates output contains two additional fields, the energy shift and
gauusian standard deviation in the UTA theory. If $m=0$, which is the default,
...
disables the angular momentum coupling performed by \key{Config}.
\end{fundesc}
