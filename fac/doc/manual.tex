...
\newcommand{\facversion}{{0.9.9}\xspace}
\newcommand{\opt}[1]{
...
the binding energy of the electron being excited. If $x$ is negative, DW is
always used. DW approximation may fail at very high energies due to the
failure of convergence in the partial-wave summation. It is therefor desirable
to switch to PW approximation at some suitable energy scale. Usually $3\le x
\ge5$ should give accurate results for both low and high energy regions. The
default for $x$ is -1.0, i.e., always use DW approximation.
\end{fundesc}
...
\begin{fundesc}{SetCETol}{t}
Set the tolerance factor in the partial-wave expansion for collisional
excitation.
\end{fundesc}
