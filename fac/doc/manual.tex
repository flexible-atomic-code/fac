...
\begin{fundesc}{Config}{c, ..., group=g $|$ g, c, ...}
...
\begin{fundesc}{CorrectEnergy}{fn, nmin $|$ ilev, e, nmin}
...
points. It must be an even number and $< 5000$ (which may be changed with the
MAXRP macro). \var{r0} specifies the ratio of successive radial points near
