      ...
      REAL*4 AR(MPDIM), BR(MPDIM), GR(MPDIM), GI(MPDIM), DR(MPDIM)
      REAL*4 DI(MPDIM), TR(MPDIM), TI(MPDIM), UR(MPDIM), UI(MPDIM)
      REAL*4 FI(MPDIM), FI1(MPDIM), MPONE(MPDIM)
      REAL*4 AI(MPDIM), BI(MPDIM), DEN(MPDIM), TR2(MPDIM)
      REAL*4 TI2(MPDIM), MPTMP(MPDIM), ZI(MPDIM), ZR(MPDIM)
