...
\begin{fundesc}{StructureMBPT}{fn, eps, g, kmax, n1, n2, n0, gn}
This is the second form of the \key{StructureMBPT} function. It examines the
configurations by exciting the electrons in the \var{g} list to orbitals with
principle quantum numbers in the \var{n1} and \var{n2} list. If its estimated
CI mixing to the states in \var{g} is larger than \var{eps}, these
configurations are put in to the group named \var{gn}. \var{n0} specifies the
minimum $n$-values of the orbitals that are allowed to be excited. The final
