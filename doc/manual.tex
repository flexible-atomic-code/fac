...
simple ASCII format. It contains 7 columns, which are lower level index, upper
level index, multipole type, transition energy, total line emissivity,
emission anisotropy at $90^\circ$, and linear polarization, respectively.
\end{fundesc}
