...
when \key{TransitionTable} is called.
If default \var{m} is used (or \var{m} = 0 is specified),
this stores the oscillator strength $gf$.
If \var{m} is specified, this stores the multipole matrix elements $M$
