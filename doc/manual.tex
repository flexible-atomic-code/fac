...
\item[\texttt{int kl}:] The principal and orbital angular momentum of the ionized shell for the dominant wavefunction component, $1000n+l$.
...
NUSR	= 6
	  ...
	  1.13491178E+04
	  1.61047286E+04
#bound  2J  free  2J Delta E      N*1000+L
     7  1      0  0  2.0454E+03   2000
# the parameters in the fitting formula
 3.7320E-02  5.3812E+00  1.2195E+00  2.0501E+03 
#user egrid RR cross sec. PI cross sec. gf
 1.0065E+02  1.9497E-01  2.1775E+00  3.3920E-02
 1.6865E+03  1.0853E-02  6.7269E-01  1.0478E-02
 4.0627E+03  3.8618E-03  2.1574E-01  3.3606E-03
 7.2978E+03  1.7648E-03  7.5929E-02  1.1827E-03
 1.1349E+04  9.1873E-04  3.0027E-02  4.6773E-04
 1.6105E+04  5.2516E-04  1.3326E-02  2.0758E-04
     8  1      0  0  1.9967E+03   2001
 3.3532E-02  5.9912E+00  1.2206E+00  2.0021E+03 
 1.0065E+02  1.8045E-01  2.1102E+00  3.2870E-02
 1.6865E+03  5.8257E-03  3.7070E-01  5.7744E-03
 4.0627E+03  1.2961E-03  7.3574E-02  1.1461E-03
 7.2978E+03  3.9921E-04  1.7356E-02  2.7036E-04
 1.1349E+04  1.4990E-04  4.9351E-03  7.6873E-05
 1.6105E+04  6.4852E-05  1.6545E-03  2.5772E-05
     9  3      0  0  1.9808E+03   2001
 6.8426E-02  5.8082E+00  1.2206E+00  1.9849E+03 
 1.0065E+02  3.5150E-01  2.0868E+00  6.5011E-02
 1.6865E+03  1.1168E-02  3.5840E-01  1.1166E-02
 4.0627E+03  2.4488E-03  6.9874E-02  2.1768E-03
 7.2978E+03  7.4406E-04  1.6230E-02  5.0563E-04
 1.1349E+04  2.7575E-04  4.5501E-03  1.4175E-04
 1.6105E+04  1.1813E-04  1.5095E-03  4.7028E-05
\end{verbatim}
...
direction. The last column shows the ratio of E1 cross section to the total when $m>1$ is specified. The last piece of data for each subshell are the $B_\lambda$ and $B_\lambda^\phi$ parameters defined as
\begin{equation}
...
multipole type \var{m} is the maximum multipole type to be included in the bound-free oscillator strength. e.g., 1 means including only E1, 2 means including E1 and M1, 3 for E1+M1+E2, 4 for E1+M1+E2+M2, etc. Default is 100 which should be enough for convergence in any cases. The results are saved in file \var{fn}.
\end{fundesc}
...
\begin{fundesc}{SetCXEGrid}{n, e0, e1, s, t $\mid$ e, t}
...
The output columns for bound orbitals are:
\begin{enumerate}
\item raidal index
\item radius $r$
\item $r Vc(r)$ the analytic part of the central potential
\item $r U(r)$ the numerical part. The sum of analytic and numeric part are the total central potential 
\item large component of the wavefunction
\item small component of the wavefunction
\end{enumerate}
For continuum orbitals, the radial grid is divided into two regions, the first from index 0 to ilast rows (ilast is given in the header of the file), the table is the same as for bound orbitals, from ilast+1 up, the table gives the the amplitudes and phases of the wavefunction, with columns in this order: 
radial index, radius, amplitude, $A$, of the large component, phase, $\phi$, of the large component, amplitude1, $A_1$, of the small component, and amplitude2, $A_2$ of the small component. the wavefunction in this region can be reconstructed as:
\begin{eqnarray}
P(r) &=& A sin(\phi) \nonumber \\
Q(r) &=& A_1 cos(\phi) + A_2 sin(\phi) \nonumber \\
\end{eqnarray}
\end{fundesc}
