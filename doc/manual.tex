...
\begin{fundesc}{Structure}{fn, \opt{, fhn}, g\opt{, p\opt{, ip}}}
...
If you specify \var{fhn}, the Hamiltonian is saved to the file \var{fhn} in the 
binary format.
%
To read the saved Hamiltonian, use \var{rfac.read_ham}.
\end{fundesc}
