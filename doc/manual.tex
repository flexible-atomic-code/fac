...
\begin{fundesc}{MBPT}{fn, g, gp, n0, n1, lmax\opt{, lmin}}
...
for the minimum principle quantum number. \var{lmax} and \var{lmin} are the maximum
and minimum orbital angular momentum of the perturbers. One should always call
\key{SetBoundary} 
