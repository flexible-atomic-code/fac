...
\begin{fundesc}{Structure}{fn, fhn, g}
This is the third form of the \key{Structure} function. It distinguishes
itself from the first and the second form because the first and second arguments 
are strings (filenames).
