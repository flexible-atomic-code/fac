...
they are invoked explicitly in the script. The energy corrections introduced
by these calls are not always desirable. They are disabled by default since
FAC version 1.1.4. 
\end{fundesc}
...
of the Uheling potential. \var{m=1} use the screening based on the expection
value of the 2nd derivative of the central potential. 
\end{fundesc}
...
\begin{fundesc}{StructureMBPT}{d,s}
  This is the sixth form of the \key{StructureMBPT} function. \var{d} and
  \var{s} specify the maximum principle quantum numbers of double and single
  excitation of various n-shells. Both \var{d} and \var{s} are lists. where
  the i-th number of the list is the limit of the excitation for $n=i+1$.
\end{fundesc}
